...
--UUID, typ podpísaného dokumentu, forma podpisania,miesto podpisania, CN, barcode, CF, podpis NB, čas vytvorenia, party ID, prospect ID (ONLY SIGNED)
...
--Typ podpísaného dokumentu, forma podpisania, čas vytvorenia, party ID, prospect ID (ONLY SIGNED)
USE QUATRO
